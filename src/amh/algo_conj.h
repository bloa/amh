...
namespace amh {
  ...
  class algo_conj : public algo<TIN,TOUT> {
  public:
    algo_conj(algo<TIN,TOUT>& _left, algo<TIN,TOUT>& _right, bool b=false) :
    ...
    algo_conj(bool truelp, bool truerp, algo<TIN,TOUT>*& _left, algo<TIN,TOUT>*& _right, bool b=false) :
    ...
    algo_conj(algo_conj_fragile<TIN,TOUT>&& _algo) :
      algo_conj(_algo.is_left_ptr(), _algo.is_right_ptr(), _algo.get_left(), _algo.get_right(), _algo.isLeaking()) {
      _algo.stealLeaks();
    }
    ~algo_conj() {
      if (leak)
  ...
  template<class TIN, class TOUT>
  class algo_conj_fragile : public algo_conj<TIN,TOUT> {
  public:
    algo_conj_fragile(algo<TIN,TOUT>& _left, algo<TIN,TOUT>& _right, bool b=false) :
      algo_conj<TIN,TOUT>(_left, _right),
      algo_left_tmp(&_left), algo_left(&algo_left_tmp),
      algo_right_tmp(&_right), algo_right(&algo_right_tmp), leak(b) {}
    algo_conj_fragile(algo<TIN,TOUT>& _left, algo<TIN,TOUT>*& _right, bool b=false) :
      algo_conj<TIN,TOUT>(_left, _right),
